...
- Name: public.spec.ts >> Public Website & Forms >> [U005] Boundary test - Location > 200 chars (Fails validation)
- Location: tests/public.spec.ts:44:7
...
Call log:
  - waiting for getByPlaceholder('e.g. Blue Macbook Air')
...
- main [ref=e3]:
  - paragraph [ref=e4]:
    ...
    - generic [ref=e9]:
      - text: "ID:"
      - code [ref=e10]: "`bom1::s2w5r-1786961213969-d666236102c3`"
