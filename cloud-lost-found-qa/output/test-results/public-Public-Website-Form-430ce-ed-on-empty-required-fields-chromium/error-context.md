...
- Name: public.spec.ts >> Public Website & Forms >> [U003] Validation triggered on empty required fields
- Location: tests/public.spec.ts:20:7
...
Call log:
  - waiting for getByRole('button', { name: 'Next: Where & When Lost' })
...
- main [ref=e3]:
  - paragraph [ref=e4]:
    ...
    - generic [ref=e9]:
      - text: "ID:"
      - code [ref=e10]: "`bom1::r2zlj-1786961149910-8ffadee972ef`"
