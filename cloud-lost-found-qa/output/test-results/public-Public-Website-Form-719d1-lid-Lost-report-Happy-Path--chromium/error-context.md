...
- Name: public.spec.ts >> Public Website & Forms >> [U004] Submit valid Lost report (Happy Path)
- Location: tests/public.spec.ts:26:7
...
- main [ref=e3]:
  - paragraph [ref=e4]:
    ...
    - generic [ref=e9]:
      - text: "ID:"
      - code [ref=e10]: "`bom1::wq9m4-1786961183171-65edc1326d3e`"
