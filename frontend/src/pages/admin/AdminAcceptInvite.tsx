...
export const AdminAcceptInvite: React.FC = () => {
        ...
        <div className="admin-card p-6 sm:p-8 space-y-6">
          {success ? (
            <div className="text-center space-y-4 py-4">
              ...
              <h2 className="text-xl font-bold text-[var(--admin-text-primary)]">Staff Account Activated</h2>
              <p className="text-xs text-[var(--admin-text-secondary)]">
                Your password has been set. You may now log in to access the administrative console.
              </p>
              <button
            ...
            <>
              <div>
                <h1 className="text-xl font-bold text-[var(--admin-text-primary)] tracking-tight">Set Your Staff Password</h1>
                <p className="text-xs text-[var(--admin-text-secondary)] mt-1">Create a password to activate your staff access privileges.</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label className="block text-xs font-medium text-[var(--admin-text-secondary)] mb-1">Create Password *</label>
                  <input
                    type="password"
                    required
                    minLength={8}
                ...
                <div>
                  <label className="block text-xs font-medium text-[var(--admin-text-secondary)] mb-1">Confirm Password *</label>
                  <input
                    type="password"
                    required
                ...
                >
                  ...
                  {loading ? 'Activating Account...' : 'Activate Staff Account'}
                </button>
              </form>
            </>
          )}
