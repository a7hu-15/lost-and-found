  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-zinc-800 pb-4">
        <div>
          <span className="text-[10px] font-mono text-emerald-400 uppercase tracking-wider">Inventory & Physical Storage</span>
          <h1 className="text-2xl font-bold text-white tracking-tight">Found Items Moderation</h1>
        </div>
                  ...
                  <tr key={item.id} className={`hover:bg-zinc-900/40 transition-colors ${isHidden ? 'bg-rose-950/10' : ''}`}>
                    ...
                    <td className="py-3 px-4 text-zinc-300">
                      <div className="flex items-center gap-1 font-mono text-[11px]">
                        ...
                        <span className="truncate max-w-xs">{item.storage_location}</span>
                      </div>
                    </td>
          ...
          <div className="saas-card max-w-md w-full p-6 space-y-5 bg-[#121215] border-zinc-700">
            ...
            <div className="flex items-center justify-between border-b border-zinc-800 pb-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-base font-bold text-white tracking-tight">Moderate Found Item</h3>
              </div>
